...
export const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    sizeDisclaimer: "If you are unsure about sizes, select the size you usually wear. If the size is not listed, please contact our customer service.",
    ...
    filterByDate: "Filter by Date (Optional)",
    ...
    rentSnowmobileTitle: "Rent a Snowmobile for Your Private Adventure by contacting us below",
    ...
    sizeDisclaimer: "Jos et ole varma kooista, valitse yleensä käyttämäsi koko. Jos koko ei ole listattu, ota yhteyttä asiakaspalveluumme.",
    ...
    availableDepartures: "Saatavilla olevat lähdöt",
    filterByDate: "Suodata päivämäärän mukaan (Valinnainen)",
    ...
    // Snowmobile Rental
    rentSnowmobileTitle:
      "Ota yhteyttä moottorikelkkavuokrausta varten",
    contactForRental:
